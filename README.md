# Forum Client – [Live App](https://forum-1ab65.web.app) React Progressive Web App

**Forum Client** is a demo React application configured as a **Progressive Web App (PWA)** using [Vite](https://vitejs.dev/).
